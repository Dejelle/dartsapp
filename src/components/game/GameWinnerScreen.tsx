...
import { GameState, GameStatistics, Player } from '../../types';
          ...
          <div className="space-y-4">
            {sortedPlayers.map((player, idx) => {
              ...
              if (isCricket && gameStats.cricketStats) {
                ...
                const hasBestAverage = stats.averagePerTurn === (bestStats as any).average;
                const hasBestHighest = stats.highestTurn === (bestStats as any).highest;
                const hasBestCheckout = stats.highestCheckout === (bestStats as any).checkout && (bestStats as any).checkout > 0;
